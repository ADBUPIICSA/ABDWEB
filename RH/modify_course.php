                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Nuevo Curso</h1>
                            <form role="form" method='post' action='save_course.php'>
                                <div class="form-group">
                                             <label>Nombre del curso</label>
                                        <?php while($row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC)){
                                         echo  "<input class='form-control' placeholder='Curso' name='nombre'
                                         value='".$row['nombre_cap']."'>" ?>

                                </div>
                                <div class="form-group">
                                            <label>Tipo</label>
                                 <?php  echo " <input class='form-control' placeholder='Curso' name='tipo'
                                ...
                                <div class="form-group">
                                            ...
                                            <select class="form-control" name="comp" >
                                                <?php while($row1 = sqlsrv_fetch_array( $stmt1, SQLSRV_FETCH_ASSOC)){
                                                    ...
                                                    if($row['id_compensacion']===$row1['id_compensacion']){
                                            echo "<option value='".$row1['id_compensacion']."' selected='selected'>"
                                                        .$row1['nombre_comp']."</option>";
                                                    }
                                                    else{
                                                    echo "<option value='".$row1['id_compensacion']."'>"
                                                    .$row1['nombre_comp']."</option>";
