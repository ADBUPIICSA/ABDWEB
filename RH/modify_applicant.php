...
$id= $_GET['id'];
 include("../db/db.php");
    ...
    $query="select * from aspirante where id_aspirante = '$id'";
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Nuevo Curso</h1>
                            <form role="form" method='post' action='save_applicant.php'>
                                <div class="form-group">
                                             <label>Nombre </label>
                                        <?php while($row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC)){
                                         echo  "<input class='form-control' placeholder='Curso' name='nombre'
                                         value='".$row['nombre']."'>" ?>

                                </div>
                                <div class="form-group">
                                            <label>Edad</label>
                                 <?php  echo " <input class='form-control' placeholder='Curso' name='edad'
                                ...
                                <div class="form-group ">
                                        ...
                                        <?php  echo  "<input type='text' class='form-control' name='telefono'
                                       value='".$row['telefono']."'>";
                                 ...
                                 <div class="form-group ">
                                        ...
                                        <?php  echo  "<input type='text' class='form-control' name='rfc'
                                       value='".$row['rfc']."'>";
                                 ...
                                 <div class="form-group ">
                                        ...
                                        <?php  echo  "<input type='text' class='form-control' name='curp'
                                       value='".$row['curp']."'>";
                                        ...
                                        ?>
                                         ...
                                         <?php  echo  "<input type='hidden' class='form-control' name='id'
                                       value='".$id."'>";
                                          }  
                                        ?>
