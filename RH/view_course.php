...
session_start(); 
 ...
 include("../db/db.php");
    ...
    $query="select id_capacitacion,nombre_cap,tipo from capacitaciones ";
                           ...
                           <table class="table table-bordered table-striped">
                             <thead>
                               ...
                               <?php while($row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC)){
                                echo "<tr>";
                                echo    "<td>".$row['nombre_cap']."</td>";
                                echo    "<td>".$row['tipo']."</td>";
                                echo    "<td> <a href='modify_course.php?id=".$row['id_capacitacion'].
                                    "'>Editar</a></td>";
                                echo" </tr>";
                                                                }
                               ?>            
...
<?php 
 ...
 if (!$_GET['confirmation']===true){ ?>  <div class="alert alert-success alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                               Guardado exitoso.
                            </div>
 <?php 
}
else{?><div class="alert alert-success alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                               Guardado exitoso.
                            </div><?php } ?>
