                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Nuevo Curso</h1>
                            <form role="form" method='post' action='new_course.php'>
                                ...
                                <div class="form-group">
                                            <label>Tipo</label>
                                            <input class="form-control" placeholder="Curso" name="tipo">
                                </div>
                                <div class="form-group">
                                            <label>Compensación</label>
                                            <select class="form-control" name="comp" >
                                                <?php while($row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC)){
                                                    echo "<option value='".$row['id_compensacion']."'>"
                                                    .$row['nombre_comp']."</option>";
                                                }       ?>
...
$duracion= $_POST['duracion'];
    ...
    $query = "insert into capacitaciones  values ('$curso','$tipo','$duracion','$comp')";
