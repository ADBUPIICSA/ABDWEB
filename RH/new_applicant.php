                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Nuevo Aspirante</h1>
                         <form role="form" method='post' action='new_applicant.php'>
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Edad</label>
                                            <input class="form-control" placeholder="Enter text" name="edad">
                                        </div>


                                            <div class="form-group">
                                            <label>Telefono</label>
                                            <input class="form-control" placeholder="Enter text" name = "telefono">
                                        </div>


                                            <div class="form-group">
                                            <label>RFC</label>
                                            <input class="form-control" placeholder="Enter text" name="rfc">
                                        </div>

                                            <div class="form-group">
                                            <label>CURP</label>
                                            <input class="form-control" placeholder="Enter text" name="curp">
                                        </div>
