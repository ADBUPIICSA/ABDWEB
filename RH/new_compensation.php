    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Nueva Compensación</h1>
                            <form role="form" method='post' action='new_compensation.php'>
                                <div class="form-group">
                                            <label>Compensación</label>
                                            <input class="form-control" placeholder="Compensación" name="compensacion">
                                </div>
                                <div class="form-group">
